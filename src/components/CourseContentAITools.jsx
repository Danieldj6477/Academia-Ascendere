// src/components/CourseContentAITools.jsx
import React from 'react';
import { Tab, Nav } from 'react-bootstrap';

const CourseContentAITools = () => {
  return (
    <div>
      <h1>Herramientas de Inteligencia Artificial para la creación de recursos educativos</h1>
      ...
      <Tab.Container id="course-tabs" defaultActiveKey="unit1">
        ...
        <Tab.Content>
          ...
          <Tab.Pane eventKey="unit3">
            <h4>Unidad 3: Creación de Recursos</h4>
...
export default CourseContentAITools;
