// src/components/CourseContentActiveMethods.jsx
      ...
      <Tab.Container id="course-tabs" defaultActiveKey="unit1">
        ...
        <Tab.Content>
          <Tab.Pane eventKey="unit1">
            <h4>Unidad 1: Introducción a las Metodologías Activas</h4>
            <p>Contenido de la unidad 1...</p>
          </Tab.Pane>
          <Tab.Pane eventKey="unit2">
            <h4>Unidad 2: Flipped Classroom</h4>
            <p>Contenido de la unidad 2...</p>
          </Tab.Pane>
          <Tab.Pane eventKey="unit3">
            <h4>Unidad 3: Aprendizaje Basado en Proyectos</h4>
            <p>Contenido de la unidad 3...</p>
          </Tab.Pane>
          <Tab.Pane eventKey="unit4">
            <h4>Unidad 4: Gamificación</h4>
